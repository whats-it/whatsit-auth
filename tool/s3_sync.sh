...
TOP="/Users/daesubkim/Desktop/WhatsIt/whatsit-auth"
#TOP="/Users/k_bluehack/whatsit/whatsit-auth"
s3cmd sync --exclude=".git/*" --exclude="node_modules/*" --recursive --default-mime-type="text/html" --guess-mime-type $TOP/static/* s3://login.whatsit.net -c ~/.s3cfg
